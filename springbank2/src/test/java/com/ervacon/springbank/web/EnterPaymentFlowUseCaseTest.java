...
public class EnterPaymentFlowUseCaseTest extends AbstractXmlFlowExecutionTests {
	...
	public void testSubmit() {
		...
		assertEquals(9850.0D,
				accountService.getAccount(new AccountNumber("SpringBank-0")).getBalance().doubleValue());
		assertEquals(2150.0D,
				accountService.getAccount(new AccountNumber("SpringBank-1")).getBalance().doubleValue());
	}
